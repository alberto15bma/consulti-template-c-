namespace CapaPresentacion.Vista.Proveedor
{
	partial class FrmNuevo
	{
		...
		private void InitializeComponent()
		{
			...
			this.tgEstado = new DevExpress.XtraEditors.ToggleSwitch();
			...
			((System.ComponentModel.ISupportInitialize)(this.tgEstado.Properties)).BeginInit();
			...
			this.btnGuardar.Location = new System.Drawing.Point(149, 10);
			...
			this.panelControl2.Location = new System.Drawing.Point(224, 10);
			this.panelControl2.Name = "panelControl2";
			this.panelControl2.Size = new System.Drawing.Size(10, 22);
			...
			// layoutControl1
			// 
			this.layoutControl1.Controls.Add(this.tgEstado);
			...
			this.layoutControl1.Size = new System.Drawing.Size(319, 260);
			this.layoutControl1.TabIndex = 2;
			this.layoutControl1.Text = "layoutControl1";
			// 
			// tgEstado
			// 
			this.tgEstado.EditValue = true;
			this.tgEstado.Location = new System.Drawing.Point(12, 180);
			this.tgEstado.Name = "tgEstado";
			this.tgEstado.Properties.GlyphAlignment = DevExpress.Utils.HorzAlignment.Far;
			this.tgEstado.Properties.OffText = "Estado";
			this.tgEstado.Properties.OnText = "Estado";
			this.tgEstado.Size = new System.Drawing.Size(295, 24);
			this.tgEstado.StyleController = this.layoutControl1;
			this.tgEstado.TabIndex = 11;
			// 
			// txtCedula
			// 
			this.txtCedula.Location = new System.Drawing.Point(80, 12);
			this.txtCedula.Name = "txtCedula";
			this.txtCedula.Properties.Mask.EditMask = "\\d{0,13}";
			...
			// txtApellidos
			// 
			this.txtApellidos.Location = new System.Drawing.Point(80, 36);
			...
			// txtNombres
			// 
			this.txtNombres.Location = new System.Drawing.Point(80, 60);
			...
			// txtEmail
			// 
			this.txtEmail.Location = new System.Drawing.Point(80, 132);
			...
			this.txtEmail.Tag = "Opcional";
			// 
			// txtRazonSocial
			// 
			this.txtRazonSocial.Location = new System.Drawing.Point(80, 84);
			...
			this.txtRazonSocial.StyleController = this.layoutControl1;
			this.txtRazonSocial.TabIndex = 9;
			this.txtRazonSocial.Tag = "Opcional";
			// 
			// txtCelular
			// 
			this.txtCelular.Location = new System.Drawing.Point(80, 156);
			this.txtCelular.Name = "txtCelular";
			this.txtCelular.Properties.Mask.EditMask = "\\d{0,10}";
			this.txtCelular.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.RegEx;
			this.txtCelular.Size = new System.Drawing.Size(227, 20);
			...
			this.txtDireccion.Tag = "Opcional";
			// 
			// layoutControlGroup1
			// 
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(319, 260);
			...
			this.layoutControlItem1.Text = "Cédula/Rúc*:";
			...
			this.simpleSeparator1.Size = new System.Drawing.Size(299, 44);
			// 
			// layoutControlItem7
			// 
			this.layoutControlItem7.Control = this.txtCelular;
			...
			this.layoutControlItem9.Text = "Dirección:";
			...
			((System.ComponentModel.ISupportInitialize)(this.tgEstado.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.ToggleSwitch tgEstado;
